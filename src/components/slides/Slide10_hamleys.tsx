...
export default function Slide10_Dreamworks(_: Props) {
  const anchor = ENTERTAINMENT_ANCHORS[1]!;
  ...
  return (
    <div className="slide-container flex bg-[#ffffff] overflow-hidden">
      ...
      <div className="w-[40%] flex flex-col justify-center px-20 border-r border-[#f0f0f0] z-10 bg-white">
        ...
        >
          <div className="text-[0.6rem] uppercase tracking-[0.3em] text-[#c4973a] mb-6">Entertainment · 02 of 04</div>
